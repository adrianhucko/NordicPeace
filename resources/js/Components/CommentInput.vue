<script setup> 
    ...
    const submitComment = () => {
    // Send the comment data to the server using axios or fetch
    axios.post('/comments', { content: commentContent.value })
        .then(response => {
...
<template>
     <div class="flex items-center mt-14 mx-6 bg-neutral-50 rounded-bo-sm">
        <form @submit.prevent="submitComment">
            ...
            <input v-model="commentContent" class="ml-6 w-100 bg-neutral-50 font-Man font-semibold text-neutral-700 outline-none placeholder:opacity-80" type="text" placeholder="Post your reply..">
