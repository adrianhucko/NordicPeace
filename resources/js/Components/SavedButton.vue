...
<template>
    <button class="flex items-center group rounded-bo @apply shadow bg-neutral-50 hover:bg-teal-500 transition duration-100 ease-in-out mt-2">
        <svg class="w-7 h-full ml-4 stroke-zinc-700 group-hover:stroke-neutral-50 transition duration-100 ease-in-out" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="Bookmark">
        ...
        <p class="font-rem font-normal text-xl pr-5 pl-2 py-3 group-hover:text-neutral-50 transition duration-100 ease-in-out">Saved</p>
    </button>
</template>