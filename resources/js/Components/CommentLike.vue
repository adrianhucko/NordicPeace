...
<template>
    <div class="flex flex-col relative mr-2">
        <button class="flex p-1 rounded-full hover:bg-neutral-200 transition duration-100 ease-in-out group">
            <svg class="w-5 h-5 fill-neutral-50 stroke-neutral-600 group-hover:fill-neutral-200 group-focus:fill-red-500 group-focus:stroke-none transition-all duration-100" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="Favorite">
        ...
        <p class="absolute left-1/2 -translate-x-1/2 top-6 font-rem text-neutral-700">8</p>
    </div>
</template>